...
// QTP Scalp Exit Watcher query builder v1.0 — Supabase-only context
...
SELECT
  r.*, e.entry_ts, e.entry_side, e.entry_price, e.entry_qty, e.entry_broker_order_id,
...
return [{ json: {
  ...
  qtp_version: 'QTP_SCALP_EXIT_WATCHER_PAPER_ONLY_v1.0_20260519',
