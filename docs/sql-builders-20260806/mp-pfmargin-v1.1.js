// PF_MARGIN Trade SQL Builder v1.1 - Option 2 PF_MARGIN paper bypass
// FIX 2026-08-06 (gov 188, exec-524111 class): v1.0 put raw Alpaca submit/order JSON into
// jsonb with quote-only escaping — NUL/lone-surrogate escapes killed the whole trade-insert
// CTE (onError=stop). v1.1: canonical jsonText + quantum.safe_jsonb.
...
const sql =
  ...
  "    " + sqlNum(notional) + ", " + sqlText(exitReason) + ", " + safeJsonbLit(audit) + "\n" +
